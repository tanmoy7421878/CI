...
def send_welcome(message):
    welcome_message = (
        "🔰 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝐕𝐄𝐍𝐎𝐌 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋™ 𝗗𝗗𝗢𝗦 𝗕𝗢𝗧 🔰\n\n" )
...
def handle_attack_details(message):
    ...
    if user_id in allowed_user_ids:
        try:
            ...
            MAX_DURATION = 160
            if user_id not in ADMIN_IDS and duration > MAX_DURATION: 160
            ...
            if user_id not in ADMIN_IDS:
                if user_id in user_cooldowns:
                    ...
                    if elapsed_time < USER_COOLDOWN: 60
        ...
        bot.send_message(message.chat.id, "🚫 𝐘𝐨𝐮 𝐍𝐞𝐞𝐝 𝐓𝐨𝐨 𝐁𝐞 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝 𝐓𝐨 𝐔𝐬𝐞 𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 𝐏𝐥𝐞𝐚𝐬𝐞 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐎𝐰𝐧𝐞𝐫 @TOXICVENOMNO1. 🚫")
...
@bot.message_handler(func=lambda message: message.text == '💰 𝐁𝐮𝐲 𝐀𝐜𝐜𝐞𝐬𝐬!')
def handle_buy_access_button(message):
    response = (f"🔆 𝐕𝐄𝐍𝐎𝐌 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋™ 𝐃𝐃𝐎𝐒 𝐏𝐑𝐈𝐂𝐄 𝐋𝐈𝐒𝐓 🔆\n\n𝖣𝖠𝖸 - 150/-𝖨𝖭𝖱\n𝖶𝖤𝖤𝖪 - 600/-𝖨𝖭𝖱\n𝖬𝖮𝖭𝖳𝖧 - 1200/-𝖨𝖭𝖱\n\nDM TO BUY @TOXICVENOMNO1")
    bot.send_message(message.chat.id, response)
...
def broadcast(message):
    if str(message.chat.id) in ADMIN_IDS:
        ...
        bot.send_message(message.chat.id, "𝐎𝐍𝐋𝐘 𝐎𝐖𝐍𝐄𝐑 𝐂𝐀𝐍 𝐔𝐒𝐄.")
